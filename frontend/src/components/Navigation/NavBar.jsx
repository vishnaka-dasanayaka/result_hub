      ...
      <div>
        <div className="navBar-l">
          ...
          <div className="navBarMiddle-l">
            <a href="navBar-l" className="navBarItem-l">Home</a>
            <a href="navBar-l" className="navBarItem-l">Exam Calender</a>
            <a href="navBar-l" className="navBarItem-l">About Us</a>
          </div>
    ...
    {isTabletOrMobile && 
      <div>
        <div className="navBar-l">
          ...
          <div className="navBarMiddle-l">
            <a href="navBar-l" className="navBarItem-t">Home</a>
            <a href="navBar-l" className="navBarItem-t">Exam Calender</a>
            <a href="navBar-l" className="navBarItem-t">About Us</a>
          </div>
